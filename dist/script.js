...
var sideBarItems = sideBar.querySelectorAll('.sidebar__item');
var header = document.querySelector('.header');
var headerTitle = header.querySelector('.header__title');
var sideBarCloseBtn = sideBar.querySelector('.sidebar__close');
var overlay = sideBar.querySelector('.sidebar__overlay'); // set active class to SideBarItem
